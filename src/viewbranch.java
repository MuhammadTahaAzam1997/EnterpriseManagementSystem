...
public void Connect(){
 ...
 Class.forName("com.mysql.jdbc.Driver");
  ...
  JOptionPane.showMessageDialog(this,e.getMessage());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VIEW BRANCH DETAILS");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "B_ID", "BRANCH NAME", "MGR_ID", "MGR START DATE"
            }
        ));
 ...
 rs=stm.executeQuery(sql);
   ...
   model.setRowCount(0);       
     while(rs.next())
   {
   model.addRow(new Object[]{rs.getString("branch_id"),rs.getString("branch_name"),rs.getString("mgr_id"),rs.getString("mgr_start_date")});
   }
   }
  catch(Exception e)
  {
