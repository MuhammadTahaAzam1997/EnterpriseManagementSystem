 ...
 Class.forName("com.mysql.jdbc.Driver");
  ...
  JOptionPane.showMessageDialog(this,e.getMessage());
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(brid)
                            .addComponent(eid, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(195, 195, 195)
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        new custrecords().setVisible(true);
        dispose();
...
String fname=customersname.getText();
String lname=brid.getText();
try{
String sql="insert into client values('"+id+"','"+fname+"','"+lname+"')";
