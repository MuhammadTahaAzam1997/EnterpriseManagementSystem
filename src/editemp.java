 ...
 Class.forName("com.mysql.jdbc.Driver");
  ...
  JOptionPane.showMessageDialog(this,e.getMessage());
    ...
    private void initComponents() {
        ...
        brid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bridActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(33, 33, 33)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(brid, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(sup, javax.swing.GroupLayout.Alignment.LEADING)
...
try{
 String sql="Update employee set fname='"+fname+"', lname='"+lname+"',bday='"+bday+"', sex='"+sex+"',salary='"+salary+"',super_id='"+super_id+"',branch_id='"+branch_id+"' where emp_id='"+eid.getText()+"' ";
...
{JOptionPane.showMessageDialog(this,e.getMessage());
    ...
    private void bridActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bridActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_bridActionPerformed
