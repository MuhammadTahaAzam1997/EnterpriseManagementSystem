...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EID", "FIRST NAME", "LAST NAME", "BIRTH DAY", "SEX", "SALARY", "SUPER ID", "BRANCH ID"
            }
        ));
 ...
 rs=stm.executeQuery(sql);
   ...
   model.setRowCount(0);       
     while(rs.next())
   {
   model.addRow(new Object[]{rs.getString("emp_id"),rs.getString("fname"),rs.getString("lname"),rs.getString("bday"),rs.getString("sex"),rs.getString("salary"),rs.getString("super_id"),rs.getString("branch_id")});
   }
   }
  catch(Exception e)
  {
