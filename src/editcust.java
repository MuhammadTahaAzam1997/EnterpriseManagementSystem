...
public void Connect(){
  ...
  JOptionPane.showMessageDialog(this,e.getMessage());
    ...
    private void initComponents() {
        ...
        jLabel13.setText("ENTER CUSTOMERS ID");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(customersname, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE))
...
String bid=brid.getText();
try{
 String sql="Update client set fname='"+fname+"', branch_id='"+bid+"' where client_id='"+jTextField8.getText()+"' ";
